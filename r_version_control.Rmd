...
Git/GitHub enables continuous software/code development by tracking code changes (**version control**) to the **initial commit**, tracking who made the changes and enabling code collaboration. Version control also helps to keep your code safe in case the laptop or hard disk with your code is lost or damaged. 
