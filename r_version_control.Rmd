...
After **committing** the changes, they are ready to be **pushed**. 
![Push](./push.png)
It is also possible to make changes on the **remote** and **pull** them to the **local**. This can also happen when the project has multiple contributors to the code. Changes made by one person to the remote can be pulled to the local repository of another person to update their code to the latest version. 

Here I make some changes on the **remote** and **commit** them. 

![Commit and pull from remote](./commit_remote.png)
Changes made and committed to the **remote**.
...
Changes made on the **remote** now **pulled** to the **local** as seen in **RStudio**. 
